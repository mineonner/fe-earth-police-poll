...
@Component({
  selector: 'police-general-hospital',
  standalone: false,
  templateUrl: './police-general-hospital.component.html',
  styleUrl: './police-general-hospital.component.scss'
})
export class PoliceGeneralHospitalComponent {
