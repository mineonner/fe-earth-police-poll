...
@Component({
  selector: 'central-investigation-bureau',
  standalone: false,
  templateUrl: './central-investigation-bureau.component.html',
  styleUrl: './central-investigation-bureau.component.scss'
})
export class CentralInvestigationBureauComponent implements AfterViewInit {
