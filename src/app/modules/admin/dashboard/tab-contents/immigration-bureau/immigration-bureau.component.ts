import { AfterViewChecked, AfterViewInit, Component, Input, SimpleChanges, ViewChild } from '@angular/core';
...
@Component({
  selector: 'immigration-bureau',
  templateUrl: './immigration-bureau.component.html',
  styleUrl: './immigration-bureau.component.scss',
  standalone: false
})
export class ImmigrationBureauComponent implements AfterViewInit {
