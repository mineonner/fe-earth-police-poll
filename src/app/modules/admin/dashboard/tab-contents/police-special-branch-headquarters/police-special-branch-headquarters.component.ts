...
@Component({
  selector: 'police-special-branch-headquarters',
  standalone: false,
  templateUrl: './police-special-branch-headquarters.component.html',
  styleUrl: './police-special-branch-headquarters.component.scss'
})
export class PoliceSpecialBranchHeadquartersComponent {
