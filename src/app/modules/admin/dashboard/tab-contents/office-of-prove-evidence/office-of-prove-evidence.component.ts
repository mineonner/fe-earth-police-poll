...
@Component({
  selector: 'office-of-prove-evidence',
  standalone: false,
  templateUrl: './office-of-prove-evidence.component.html',
  styleUrl: './office-of-prove-evidence.component.scss'
})
export class OfficeOfProveEvidenceComponent {
